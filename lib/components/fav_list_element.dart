...
/// StatelessWidget FavouriteListElement is one element of the favourite list
/// responsible for selecting background color and content of card
/// returns a new Card widget
class FavouriteListElement extends StatelessWidget {
  Contact contact;

  FavouriteListElement(Contact contact) {
